...
client_system:
    while (1)
    {
        ...
        else if (order == "mkdir")
        {
            ...
            if (!flag)
            {
                cout << order << ":"<< "cannot create directory ‘"<< name <<"’: File exists" << endl;
            }
        }
        /*******************************rmdir*****************************/
        else if (order == "rmdir")
        {
            ...
            if (!flag)
            {
                ...
                cout << order << ":"<< name << " No such file or directory";
            }
        }
        /*******************************cd*****************************/
        else if ("cd" == order)
        {
            ...
            else
            {
                ...
                if (!flag)
                {
                    cout << order << ":" << name << ":" << " No such file or directory"<< endl;
                    continue;
                }
